...
Future<dynamic> _androidMethodCallHandler(MethodCall call) async {
  switch (call.method) {
    case 'locationTrackingService':
      ...
      NotifyService.showTextNotification(title: 'Current Location', body: "$pathLocation");
      break;
  }
}
...
void startServiceInPlatform() async {
  if (Platform.isAndroid) {
    ...
    NotifyService.showTextNotification(title: 'Current Location', body: result);
  }
}
...
void main() {
  ...
  //initializeService(); // not required as service is in android background
  startServiceInPlatform();
  runApp(MyApp());
}
